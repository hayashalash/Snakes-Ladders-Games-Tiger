...
public class choosePlayersStage extends Application {
    ...
    public void start(Stage primaryStage) {
		...
		//the selectedDifficulty 
		System.out.println("Selected Difficulty in choosePlayersStage: " + selectedDifficulty);
