...
public class normalGameStage extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("normalGame");
        ...
        Image backgroundImage = new Image(getClass().getResource("/View/normalStageBack.jpg").toExternalForm());
